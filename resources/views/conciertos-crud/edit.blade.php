...
<body>
    ...
    <div class="container">
       ...
       <form action="{{ secure_url(route('conciertos-crud.update', $concierto->id)) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="two-columns">
                ...
                <div class="form-group">
                    ...
                    >
                    @error('boletos_disponibles')
                        <span class="error">{{ $message }}</span>
                    @else
                        <span class="help-text">Actualiza según ventas</span>
                    @enderror
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    type="url" 
                    name="imagen_url" 
                    value="{{ old('imagen_url', $concierto->imagen_url) }}" 
